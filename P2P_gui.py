...
class PTab():
    ...
    def show(self):
        ...
        # self.tab.grid(row=1,columnspan=4,sticky=W+E+N+S)
...
# print(self.info_l.config()["relief"])
...
class DownloadTab(PTab):
    ...
    def fill(self):
        ...
        self.titleList = tkinter.scrolledtext.ScrolledText(self.tab,
                                                           fg='black', bg='lightgray', font=("黑体", 11), relief=GROOVE,
                                                           width=128, height=20)
        ...
        self.titleList.insert(1.0, title)
